...
#total 299
write.table(totalseq_uniq.lcpm, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/299.IBD.txt", sep="\t", row.names=T, col.names=T, quote=F)
write.table(truseq_uniq.lcpm, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/155.IBD.txt", sep="\t", row.names=T, col.names=T, quote=F)

#UC_in
w <- which(Totalseq.group == "UC_in")
n <- names(Totalseq.group[w])
UC_in <- totalseq_uniq.lcpm[,n]
write.table(UC_in, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/299.UC_in.txt", sep="\t", row.names=T, col.names=T, quote=F)

w <- which(Truseq.group == "UC_in")
n <- names(Truseq.group[w])
UC_in <- truseq_uniq.lcpm[,n]
write.table(UC_in, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/155.UC_in.txt", sep="\t", row.names=T, col.names=T, quote=F)

#UC_no
w <- which(Totalseq.group == "UC_no")
n <- names(Totalseq.group[w])
UC_no <- totalseq_uniq.lcpm[,n]
write.table(UC_no, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/299.UC_no.txt", sep="\t", row.names=T, col.names=T, quote=F)

w <- which(Truseq.group == "UC_no")
n <- names(Truseq.group[w])
UC_no <- truseq_uniq.lcpm[,n]
write.table(UC_no, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/155.UC_no.txt", sep="\t", row.names=T, col.names=T, quote=F)

#CD_in
w <- which(Totalseq.group == "CD_in")
n <- names(Totalseq.group[w])
CD_in <- totalseq_uniq.lcpm[,n]
write.table(CD_in, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/299.CD_in.txt", sep="\t", row.names=T, col.names=T, quote=F)

w <- which(Truseq.group == "CD_in")
n <- names(Truseq.group[w])
CD_in <- truseq_uniq.lcpm[,n]
write.table(CD_in, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/155.CD_in.txt", sep="\t", row.names=T, col.names=T, quote=F)

#CD_no
w <- which(Totalseq.group == "CD_no")
n <- names(Totalseq.group[w])
CD_no <- totalseq_uniq.lcpm[,n]
write.table(CD_no, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/299.CD_no.txt", sep="\t", row.names=T, col.names=T, quote=F)

w <- which(Truseq.group == "CD_no")
n <- names(Truseq.group[w])
CD_no <- truseq_uniq.lcpm[,n]
write.table(CD_no, "/scratch/hpc46a05/gy_RNA/IBD/06.Cibersortx/NotfilterByExpr/01.edgeR/155.CD_no.txt", sep="\t", row.names=T, col.names=T, quote=F)
